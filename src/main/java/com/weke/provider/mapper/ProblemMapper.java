...
public interface ProblemMapper {
    ...
    @Insert("insert into problem(answer_num,user_id,problem_info,view_number,problem_title,course_id)" +
            " values(#{problem.answerNum},#{problem.userId},#{problem.problemInfo},#{problem.viewNumber},#{problem.problemTitle},#{problem.courseId})")
